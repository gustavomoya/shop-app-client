...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/core/token.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/core/client.js":[function(require,module,exports) {
"use strict";
...
var Client = /*#__PURE__*/_createClass(function Client() {
  ...
  _defineProperty(this, "getCliente", function () {
    return _this.axios;
  });

  _defineProperty(this, "getCancelToken", function () {
    return _this.cancelToken;
  });

  _defineProperty(this, "cancel", function () {
    _this.cancelToken.cancel("Component unmounted.");

    _this.cancelToken = _axios.default.CancelToken.source();
  });

  _defineProperty(this, "setBearerToken", function () {
    _this.axios.defaults.headers.common["Authorization"] = "Bearer ".concat((0, _token.default)().token);
    return _this;
  });

  _defineProperty(this, "deleteBearerToken", function () {
    delete _this.axios.defaults.headers.common["Authorization"];
    return _this;
  });

  _defineProperty(this, "setHeaders", function (headers) {
    _this.axios.defaults.headers.common = headers;
    return _this;
  });

  _defineProperty(this, "setProps", function (props) {
    _this.props = props;
    return _this;
  });
  ...
  this.cancelToken = _axios.default.CancelToken.source();
...
exports.default = _default;
},{"axios":"node_modules/axios/index.js","./token":"js/core/token.js"}],"js/config.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"js/authentication.js":[function(require,module,exports) {
"use strict";

var _client = _interopRequireDefault(require("./core/client"));

var _token = _interopRequireDefault(require("./core/token"));
...
var init = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var sessionData, form, _form;

    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            sessionData = (0, _token.default)();
          ...
          case 9:
            ...
            if (document.querySelector('#login-form')) {
              _form = document.querySelector('#login-form');
              loginForm.form = _form;
              loginForm.email = _form.querySelector('#email');
              loginForm.password = _form.querySelector('#password');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 4;
            _context2.next = 7;
            return _client.default.setBearerToken().getCliente().post("".concat(_config.default, "/register"), _objectSpread({}, values));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 4;
            _context3.next = 7;
            return _client.default.setBearerToken().getCliente().post("".concat(_config.default, "/login"), _objectSpread({}, values));
...
var showProducts = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var result, template, tbody, trWrapper;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 5;
            return _client.default.setBearerToken().getCliente().get("".concat(_config.default, "/products"));

          case 5:
            result = _context4.sent;
            template = document.querySelector('#row-product-template');

            if (result && result.data) {
              tbody = document.querySelector('.product-table tbody');
              trWrapper = template.content.firstElementChild.cloneNode(true);
              result.data.map(function (p) {
                trWrapper.querySelectorAll('td').forEach(function (td, index) {
                  switch (index) {
                    case 0:
                      td.innerHTML = p.name;
                      break;
...
},{"./core/client":"js/core/client.js","./core/token":"js/core/token.js","./config":"js/config.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33123" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/authentication.js"], null)
//# sourceMappingURL=/authentication.200a74e3.js.map